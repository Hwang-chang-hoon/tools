	...
	public Chap2Panel(MainFrame mainFrame) {
		...
		ex_Button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				context = new String[][] { { "1", "그렇다", "없다", "아니다", "아니다" }, 
										   { "2", "그렇다", "없다", "그렇다", "아니다" },
										   { "3", "아니다", "없다", "아니다", "그렇다" }, 
										   { "4", "아니다", "없다", "그렇다", "아니다" },
										   { "5", "아니다", "있다", "그렇다", "그렇다" } };
